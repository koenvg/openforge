...
impl PluginHost {
    pub(super) async fn handle_host_callback(
        ...
        match method {
            ...
            "openforge.fs.task.readDocument" => self.read_task_document_for_host(params).await,
            ...
            "openforge.fs.task.readFile" => self.read_task_file_for_host(params).await,
            "openforge.fs.task.searchFiles" => self.search_task_files_for_host(params),
