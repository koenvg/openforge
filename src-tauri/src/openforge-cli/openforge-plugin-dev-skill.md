...
5. Add focused tests with `@openforge/plugin-sdk/testing` for package metadata, runtime registrations, command/backend method behavior, storage scoping, and cleanup.
...
3. Add or update focused tests with `@openforge/plugin-sdk/testing` when behavior changes.
