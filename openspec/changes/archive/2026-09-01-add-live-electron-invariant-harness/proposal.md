...
- Add focused commands, scenario filters, unit coverage, live E2E coverage, documentation, generated-artifact ignores, and a pull-request terminal-race job; keep macOS idle validation operator-invoked.
