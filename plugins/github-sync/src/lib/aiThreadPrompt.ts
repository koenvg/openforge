...
export function buildQuestionsPrompt(
  ...
  return [
    'You are the AI assistant that generated this pull request\'s walkthrough and review, now answering a follow-up question about your own notes. You are running inside a checkout of the PR head. Read any file and use git history to answer precisely and honestly. If a choice was arbitrary, say so.',
