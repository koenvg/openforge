...
export function createReviewWorkspace(api: FrontendOpenForgeAPI, getContext: () => ReviewWorkspaceContext) {
  ...
  let detailModel = $derived(selectedPr.current ? {
    ...
    reviewUpdateAvailable: selection.reviewUpdateAvailable,
    isRefreshingReview: selection.isRefreshingReview,
    reviewRefreshError: selection.reviewRefreshError,
    pendingCommentsToReview: selection.pendingCommentsToReview,
    ...
    onBackToList: selection.backToList,
    onRefreshReview: selection.refreshReview,
