<script lang="ts">
  ...
  import TaskPaneNavigation from '../../../src/components/task-detail/TaskPaneNavigation.svelte'
  import type { ResolvedTab } from '../../../src/lib/plugin/contributionResolver'

  let { children, tab, taskId = 'T-42', onSelect = () => {} }: {
    children: Snippet
    tab: ResolvedTab
    taskId?: string
