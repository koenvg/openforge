...
export function createTestingCalls(): TestingOpenForgeApiCalls {
  return {
    ...
    scopedAgentSessionStarts: [],
    scopedAgentSessionStatuses: [],
    scopedAgentSessionInputs: [],
    scopedAgentSessionAborts: [],
    scopedAgentSessionReleases: [],
    scopedAgentSessionTerminalMounts: [],
    scopedAgentSessionTerminalDetaches: [],
