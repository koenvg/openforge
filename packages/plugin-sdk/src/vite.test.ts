...
describe('OpenForge plugin Vite author tooling', () => {
  it('creates exact source aliases for public plugin SDK entrypoints', () => {
    ...
    expect(aliases).toEqual([
      ...
      { find: '@openforge-app/plugin-sdk/ui/StatusBadge.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/StatusBadge.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/LoadingIndicator.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/LoadingIndicator.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Alert.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Alert.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Progress.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Progress.svelte' },
      ...
      { find: '@openforge-app/plugin-sdk/ui/SearchPalette.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/SearchPalette.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/PaletteListbox.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/PaletteListbox.svelte' },
  ...
  it('creates a record-shaped source alias map for Vitest configs', () => {
    expect(createOpenForgePluginSdkSourceAliasRecord(new URL('file:///repo/'))).toEqual({
      ...
      '@openforge-app/plugin-sdk/ui/StatusBadge.svelte': '/repo/packages/plugin-sdk/src/ui/StatusBadge.svelte',
      '@openforge-app/plugin-sdk/ui/LoadingIndicator.svelte': '/repo/packages/plugin-sdk/src/ui/LoadingIndicator.svelte',
      '@openforge-app/plugin-sdk/ui/Alert.svelte': '/repo/packages/plugin-sdk/src/ui/Alert.svelte',
      '@openforge-app/plugin-sdk/ui/Progress.svelte': '/repo/packages/plugin-sdk/src/ui/Progress.svelte',
      ...
      '@openforge-app/plugin-sdk/ui/SearchPalette.svelte': '/repo/packages/plugin-sdk/src/ui/SearchPalette.svelte',
      '@openforge-app/plugin-sdk/ui/PaletteListbox.svelte': '/repo/packages/plugin-sdk/src/ui/PaletteListbox.svelte',
