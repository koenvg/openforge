...
| Plugin-safe SDK UI | `@openforge-app/plugin-sdk/ui/MarkdownContent.svelte`, `@openforge-app/plugin-sdk/ui/ResizablePanel.svelte` | Any OpenForge plugin | Allowed. This is the stable plugin-safe UI surface. |
