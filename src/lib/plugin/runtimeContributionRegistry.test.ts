...
describe('runtime contribution registry', () => {
  ...
  it('supports frontend-only plugins using storage, task creation, and notifications', async () => {
    const createdTask = { id: 'T-scheduled', initial_prompt: 'Scheduled prompt', prompt: null, title: null, title_source: null, title_generated_at: null, summary: null, status: 'backlog' as const, agent: null, permission_mode: null, worktree_source: null, worktree_branch: null, handoff_notes_enabled: true, resume_session_id: null, depends_on: [], project_id: 'P-1', created_at: 3, updated_at: 3 }
    const host = {
  ...
  it('exposes typed core API wrappers through the configured host bridge', async () => {
    const createdTask = { id: 'T-2', initial_prompt: 'New prompt', prompt: null, title: null, title_source: null, title_generated_at: null, summary: null, status: 'backlog' as const, agent: null, permission_mode: null, worktree_source: null, worktree_branch: null, handoff_notes_enabled: true, resume_session_id: null, depends_on: ['T-1'], project_id: 'P-1', created_at: 3, updated_at: 3 }
    const host = {
