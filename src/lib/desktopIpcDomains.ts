...
export const desktopIpcFunctionDomains = {
  ...
  listReviewThreads: 'files-review',
  createReviewThread: 'files-review',
  replyToReviewThread: 'files-review',
  setReviewThreadStatus: 'files-review',
  setReviewThreadAwaiting: 'files-review',
  markReviewThreadSeen: 'files-review',
  ...
  startScopedAgentSession: 'agent-session-pty',
  getScopedAgentSessionStatus: 'agent-session-pty',
  inputScopedAgentSession: 'agent-session-pty',
  abortScopedAgentSession: 'agent-session-pty',
  releaseScopedAgentSession: 'agent-session-pty',
