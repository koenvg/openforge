...
export const ipcCommandContracts = [
  ...
  { functionName: 'startImplementation', ipcCommand: 'start_implementation', payloadKeys: ['taskId', 'repoPath', '...options'], targetOwner: 'rust-sidecar', domain: 'tasks-projects' },
  { functionName: 'pluginStartImplementation', ipcCommand: 'plugin_start_implementation', payloadKeys: [], targetOwner: 'rust-sidecar', domain: 'tasks-projects' },
  { functionName: 'resumeImplementation', ipcCommand: 'resume_implementation', payloadKeys: [], targetOwner: 'rust-sidecar', domain: 'agent-session-pty' },
