...
export const ipcCommandContracts = [
  ...
  { functionName: 'startImplementation', ipcCommand: 'start_implementation', payloadKeys: ['taskId', 'repoPath', 'divergenceResolution', 'terminalImageProtocol', 'promptPrefix'], targetOwner: 'rust-sidecar', domain: 'tasks-projects' },
