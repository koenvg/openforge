...
<div class="flex flex-col gap-3 h-full" data-testid="pi-agent-panel">
        ...
        {#if session}
          <div class="flex items-center gap-2">
            ...
            {#if session.pi_session_id}
              <span class="text-[0.6875rem] font-mono text-secondary max-w-[180px] truncate" title={session.pi_session_id}>
